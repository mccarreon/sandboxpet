...
public partial class MyGame : Sandbox.GameManager
{
	...
	public override void ClientJoined( IClient client )
	{
		...
		PetTerry petTerry = new PetTerry(client);
		petTerry.Spawn();
		petTerry.Position = petTerry.Owner.Position.WithZ( 0 );
		Log.Info( $"Terry's owner: {petTerry.Owner.Name}" );
	}

	[ConCmd.Server("respawn_players")]
